...
public class Mark {
    ...
    /**
     * Returns the Student ID of this Mark
     * This method is used in FILEMgr.generalWriter() to reflexively write the headers for the data files.
     * @return The ID of the student this mark belongs to.
     */
    public String getStudentID() { return student.getStudentID();}

    /**
     * Returns the Course ID of this Mark
     * This method is used in FILEMgr.generalWriter() to reflexively write the headers for the data files.
     * @return The ID of the course this mark belongs to.
     */
